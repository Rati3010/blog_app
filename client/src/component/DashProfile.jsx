...
const DashProfile = () => {
  ...
  const uploadImage = () => {
    ...
    uploadTask.on(
      ...
      (error) =>{
        setImageUploadingError('please upload image below 2MB');
        ...
        <div className="relative w-32 h-32 self-center cursor-pointer shadow-md overflow-hidden rounded-full" onClick={() => filePickerRef.current.click()}>
          {
            imageUploadingProgress && (
              <CircularProgressbar value={imageUploadingProgress || 0} text={`${imageUploadingProgress}%`} strokeWidth={5} 
              styles={{
                root:{
                  width:'100%',
                  height:'100%',
          ...
          <img
            ...
            alt="profile"
            className={`rounded-full w-full h-full object-cover border-8 border-[lightgray] ${imageUploadingProgress && imageUploadingProgress <100 && 'opacity-60'}`}
